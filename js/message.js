...
obj.effects = {
       ...
       getStyle : function() {
           return obj.elements.messageBox.attr('fadeStyle')
        } 
    }
...
getThemes :  function(elem){
             var theme_name = obj.elements.messageBox.attr('theme');
             var getStyle = obj.elements.messageBox.attr('fadeStyle');

             if (this.IsvalidProp(getStyle, fadeEffects)) {     
                obj.elements.messageBox.find('img.closeIcon').on('click', obj.effects[getStyle]);       
                   } else {
                obj.elements.messageBox.find('img.closeIcon').on('click', obj.effects['noEffect']) 
               }
...
timeoutManager : function() {
       var timeout_value = obj.elements.messageBox.attr('timeout');
...
var messageTimeOut = function(duration) {
                obj.elements.messageBox.fadeOut(duration);
            }
